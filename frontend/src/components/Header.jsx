...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      {/*----- left side ------- */}
      <div className="hover:scale-101 transition-all duration-700 cursor-pointer">
        ...
        <p className="my-6 text-[15px] text-gray-500">
          ...
          industry.
          <br className="max-sm:hidden"/> Lorem Ipsum has been the industry's standard dummy text ever.
        </p>

        <div>
          <input type="file" id="upload1" name="" />
      ...
      {/*----- Right side ------- */}
      <div className="w-full max-w-md hover:scale-105 transition-all duration-700 cursor-pointer">
